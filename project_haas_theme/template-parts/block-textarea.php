...
if (!empty($textareal)) : ?>
    <div style="color: #efefef; text-align: center; margin: 2.5% 0%;"class="<?php echo $class_name ?>">
            ...
            <h2><?php
                ...
                echo $textareal['headline'];
                
                ?></h2>
                <?php if ($textareal['textarea']) {
                    echo ' <p class="textareaclass">'  . $textareal['textarea'] . '</p>';
                }
                ?>
        ...
        */
        echo wp_get_attachment_image($textareal['image'], 'medium_large', false, ['class' => 'textareaimage'])
        ?>
